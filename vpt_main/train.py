...
def setup(args):
    ...
    # setup dist
    # cfg.DIST_INIT_PATH = "tcp://{}:12399".format(os.environ["SLURMD_NODENAME"]) # @hlwong
    ...
    cfg.DATA.NAME, cfg.DATA.FEATURE, f"lr={lr}_wd={wd}_loc={cfg.MODEL.PROMPT.LOCATION}_numTok={nt}")
